...
pibox() { ~/develop/github.com/badjware/pibox/launch.sh --sac-moe-patience -v "$HOME/go/pkg:$HOME/go/pkg" "$@" }
claudebox() { ~/develop/github.com/badjware/pibox/launch.sh --sac-moe-patience --harness claude -v "$HOME/go/pkg:$HOME/go/pkg" "$@" }
